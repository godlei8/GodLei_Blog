  ...
  data() {
    return {
        ...
        },
      {
          ...
          version: 'v1.2.0',
          changes: [
            '将友链数据存在了数据库，并动态展示在前端',
            '管理端：实现管理端对友链信息进行管理的功能',
            '管理端：实现了管理端对文章进行关键词搜索',
            '管理端：添加了分类目录视图，可以更清晰地看明白目录关系',
            '前端：固定了文章的目录显示',
        ...
        },
      {
          ...
          version: 'v0.14.0',
          changes: [
            '前端：制作了about页，包含个人简介，社交账号，技术栈，追番列表',
          '前端：修复了进入文章页面总是跳转到中间的问题',
            '管理端：添加了分类管理和标签管理的功能',
            '管理端：重写了管理端页面的样式',
            '修改了SQL建表脚本',
            '大量更新了README.md,完善了文档内容，新增了数据库设计说明、英文文档'
        ...
        },
      {
          ...
          version: 'v0.12.0',
          changes: [
            '管理端：添加了解析分类和标签并添加到数据库的功能',
            '管理端：添加了编辑文章的功能',
            '前端：文章页面的代码块样式优化', 
            '前端：文章页面增加了评论、目录、跳转至顶部的悬浮球', 
            '前端：文章页面做了手机适配',
            '前端：迁移了旧站的友链以及部分评论数据',
            '前端：分页查询文章按照了更新顺序排序',
            '前端：调整了首页样式',
...
.current-badge {
  ...
  font-size: 0.6em;
  font-weight: 700;
  background: rgba(214, 173, 92, 0.16);
